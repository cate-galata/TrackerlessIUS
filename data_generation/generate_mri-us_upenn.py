...
for folder in tqdm(os.listdir(path_data)):
    ...
    if os.path.exists(os.path.join("/lustre/fsn1/projects/rech/jkq/ubt15jc/upenn", folder)) and len(os.listdir(os.path.join("/lustre/fsn1/projects/rech/jkq/ubt15jc/upenn", folder, 'data_mri'))) >= 190:
    ...
    for modalities_set in total_subsets_mr:
        ...
        ultrasounds_subset = itertools.cycle(ultrasounds)
