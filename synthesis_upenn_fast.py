...
def main():
    ...
    path_data = f'/lustre/fsn1/projects/rech/jkq/ubt15jc/{opt.dir}'
    ...
    for folder in tqdm(os.listdir(path_data)):
        ...
        # PHASES
        nii_files = [k for k in os.listdir(input_path) if 'fov.nii.gz' in k]
...
def parsing_data():
    ...
    parser.add_argument('--dir',
                        type=str,
                        default='synthetic_mri-us',
                        help='Process MRI-US or US-US')
